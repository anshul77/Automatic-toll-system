...
def processing():
    ...
    vehicleNumber = "HA54NMR" #getvehicleNumber.detectVehicleNumber(filepath, , , )
    # print vehicleNumber
    ...
    balance = str(vehicleDetails[0][2])
    ...
    resultVehicleBalance.config(text = "Vehicle balance = " + balance)
